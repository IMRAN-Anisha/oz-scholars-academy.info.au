      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-8">
          <div className="text-center">
            <div className="mb-2 text-2xl font-bold text-[#00D66B]">50+</div>
          ...
          <div className="text-center">
            <div className="mb-2 text-2xl font-bold text-[#FFD700]">100%</div>
            <div className="text-sm text-gray-600">Free Strategy Consultations</div>
          </div>
        </div>
      </div>
    </section>
